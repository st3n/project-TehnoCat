...
def show_help():
    ...
    commands = [
        ...
        (
            "add",
            "Add new contact in the phone book. After the command, write your name and phone number",
        ),
        (
            "change",
            "Change the saved contact phone. After the command, write your name, old phone number and new phone number",
        ),
        (
            "change",
            "Change the saved contact email. After the command, write your name, old email and new email",
        ),
        (
            "change",
            "Change the saved contact address. After the command, write your name, old adress and new adress",
        ),
        (
            "remove",
            "Remove contact. After the command, write the name you want to delete",
        ),
        (
            "remove",
            "Remove phone. After the command, write the name and contact phone number you want to delete",
        ),
        (
            "remove",
            "Remove email. After the command, write the name and contact email you want to delete",
        ),
        (
            "remove",
            "Remove adress. After the command, write the name and contact adress you want to delete",
        ),
        (
            "phone",
            "Show the phone of the user with entered name. After the command, write your name",
        ),
        (
            "add-birthday",
            "Add birthday for contact. After the command, write your name and birthday in format 'DD.MM.YYYY'",
        ),
        (
            "add-email",
            "Add email for contact. After the command, write your name and email for contact",
        ),
        (
            "add-address",
            "Add address for contact. After the command, write your name and address for contact",
        ),
        (
            "show-birthday",
            "Show birthday for contact. After the command, write your name",
        ),
        ("show-email", "Show email for contact. After the command, write your name"),
        (
            "show-address",
            "Show address for contact. After the command, write your name",
        ),
