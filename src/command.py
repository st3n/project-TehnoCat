...
def command_exists(command_name):
   return any(command_info.get('name') == command_name for command_info in bot_commands())

def find_command_by_name(command_name):
   return next((command_info for command_info in bot_commands() if command_info.get('name') == command_name), None)
